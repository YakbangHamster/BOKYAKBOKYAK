...
android {
    ...
    packagingOptions {
        exclude("libtensorflowlite_jni_gms_client.so")
    }
}
...
dependencies {
    ...
    implementation("com.google.mlkit:object-detection:17.0.2") // 최신 stable
    implementation("com.google.mlkit:object-detection-custom:17.0.2") // 커스텀 모델
